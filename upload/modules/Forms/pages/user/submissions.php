...
if (!isset($_GET['view'])) {
    ...
    if (empty($submission->content)) {
        ...
        $fields = DB::getInstance()->query('SELECT name, value FROM nl2_forms_replies_fields LEFT JOIN nl2_forms_fields ON field_id=nl2_forms_fields.id WHERE submission_id = ?', [$submission->id])->results();
